...
result_message = {'message_type':'result', 'task_id':None, 'content':None, 'time_requirement': None, 'sending_time':None, 'distribution_time':None, 'execution_time':None, 'task_type':None, 'offload_times':None, 'process_by':None}
